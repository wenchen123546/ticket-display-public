...
const adminLogUI = document.getElementById("admin-log-ui"); // 【新增】
...
function adminLog(message) {
    ...
    adminLogUI.prepend(li); // 將最新一筆加到最上方
}

// --- 6. 控制台 Socket 監聽器 (已加入 Log) ---
socket.on("connect", () => { 
...
async function resetAll() {
    ...
    if (confirmation !== "RESET") { alert("操作已取消。"); return; }

...
async function checkLine(c) {
    ...
    try {
        ...
        const send = (ids, txt) => { while (ids.length) lineClient.multicast({ to: ids.splice(0, 500), messages: [{ type: 'text', text: txt }] }).catch(e => console.error("LINE Push Error:", e.message)); };
